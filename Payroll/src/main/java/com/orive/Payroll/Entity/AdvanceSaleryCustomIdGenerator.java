...
public class AdvanceSaleryCustomIdGenerator implements IdentifierGenerator{

	
	private static final long serialVersionUID = 1L;

	private final String prefix = "ORIADVNCSAL-";
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		...
		try {
			...
			String query = "SELECT MAX(advance_salery_id), COUNT(advance_salery_id) FROM advance_salery";
