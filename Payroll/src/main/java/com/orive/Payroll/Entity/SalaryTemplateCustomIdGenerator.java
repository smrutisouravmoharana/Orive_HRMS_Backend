...
public class SalaryTemplateCustomIdGenerator implements IdentifierGenerator{

	
	private static final long serialVersionUID = 1L;

	private final String prefix = "ORISALTML-";
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		...
		try {
			...
			String query = "SELECT MAX(salary_template_id), COUNT(salary_template_id) FROM salary_template";
