...
public class PaySlipGenerateCustomIdGenerator implements IdentifierGenerator {

	
	private static final long serialVersionUID = 1L;

	private final String prefix = "ORIPYSLGT-";
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		...
		try {
			...
			String query = "SELECT MAX(pay_slip_generate_id), COUNT(pay_slip_generate_id) FROM pay_slip_generate";
