...
public class PerformanceAppraisalCustomIdGenerator implements IdentifierGenerator {

	private static final long serialVersionUID = 1L;

	private final String prefix = "ORIPRFMNCEAL-";
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) {
		...
		try {
			...
			String query = "SELECT MAX(performance_appraisal_id), COUNT(performance_appraisal_id) FROM performanceappraisal";
